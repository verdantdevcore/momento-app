...
export function Footer({ variant = 'default' }: FooterProps) {
  ...
  if (variant === 'minimal') {
    return (
      <footer style={{ borderTop: '1px solid var(--border)', padding: '0.875rem 1rem', textAlign: 'center' }}>
        <p style={{ color: 'var(--text-dim)', fontSize: '0.725rem', margin: 0 }}>
  ...
  return (
    <footer style={{ borderTop: '1px solid var(--border)', backgroundColor: 'var(--bg-surface)', padding: '1.25rem 1.5rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.75rem' }}>
        ...
        {/* Left — brand text, no logo */}
        <div>
          <p style={{ color: 'var(--text-dim)', fontSize: '0.65rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 0.125rem' }}>By</p>
          <p style={{ color: 'var(--text-dim)', fontSize: '1rem', fontWeight: 800, margin: '0 0 0.2rem', letterSpacing: '-0.01em' }}>Verdant DevCore</p>
